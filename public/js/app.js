...
function initAdmin(socket) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/admin/orders', {
    ...
    orders = res.data; // here data is received from model
...
function updateStatus(order) {
  statusline.forEach(function (curr) {
    curr.classList.remove('step-completed');
    curr.classList.remove('current');
  });
  var stepCompleted = true;
  statusline.forEach(function (curr) {
    var currstatus = curr.dataset.status;
...
__webpack_require__(/*! D:\SublimeProjects\web-development\realtime-pizza\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\SublimeProjects\web-development\realtime-pizza\resources\scss\app.scss */"./resources/scss/app.scss");
